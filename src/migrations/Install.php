...
class Install extends Migration
{
  ...
  public function safeUp()
  {
    ...
    $columns = [
      ...
      "sunrise" => $this->timestamp()->default(\DB::raw("CURRENT_TIMESTAMP")),
      "sunset" => $this->timestamp()->default(\DB::raw("CURRENT_TIMESTAMP")),
    ...
    // create indexes
    $this->createIndex(
      "open_weather_entries_lat_lon_idx",
      "{{%open_weather_entries}}",
      ["lat", "lon"],
      true
    );
    $this->createIndex(
      "open_weather_entries_city_id_idx",
      "{{%open_weather_entries}}",
      ["city_id"],
      true
    );
    $this->createIndex(
      "open_weather_entries_city_name_country_idx",
      "{{%open_weather_entries}}",
      ["city_name", "country_iso"]
    );
  }
